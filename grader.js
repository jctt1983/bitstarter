...
if(require.main == module) {
	...
	.option('-u, --url <urk_point>','Url to web page', clone(assertUrlExists), CHECKURL_DEFAULT)
	.parse(process.argv);

    if(CHECKURL_DEFAULT!=program.url){
